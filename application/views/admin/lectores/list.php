<section class="content-header">
    <h1>
        Lector de Codigo <small> Listado</small>
    </h1>
...
<section class="content">
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="<?php echo base_url();?>equipos/lectores/add" class="btn btn-primary btn-flat"><span class="fa fa-plus"></span>Agregar Lector de Codigo</a>
                    <hr>
                            ...
                            <tbody>
                                <?php foreach ($lectores as $lector): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $lector->ultimo_mante?></td>
                                        <td><?php echo $lector->nombres?></td>
                                        <td><?php echo $lector->estado == 0 ?"Inactivo":"Activo";?></td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a href="<?php echo base_url();?>equipos/lectores/edit/<?php echo $lector->id?>" class="btn btn-warning btn-flat" title="Editar"><span class="fa fa-pencil"></span></a>
                                                <?php if ($this->session->userdata("rol") == 1):  ?>
                                                    <a href="<?php echo base_url();?>equipos/lectores/delete/<?php echo $lector->id?>" class="btn btn-danger btn-flat btn-delete" title="Eliminar">
                                                    <span class="fa fa-times"></span>
                                                </a>
                                                <?php endif ?>
                                                
                                                <button type="button" class="btn btn-info btn-flat btn-mante" data-toggle="modal" data-target="#modal-mantenimiento" title="Mantenimientos" value="<?php echo $lector->id?>">
      ...
      <div class="modal-body">
        ...
        <div class="tab-content">
            ...
            <div id="agregar" class="tab-pane fade">
                ...
                <form action="<?php echo base_url();?>equipos/lectores/addmantenimiento" method="POST">
