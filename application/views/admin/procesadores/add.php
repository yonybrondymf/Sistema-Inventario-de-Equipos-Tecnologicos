<section class="content-header">
    <h1>
        Procesadores <small>Registro</small>
    </h1>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6 col-sm-8 col-xs-12">
                    <form action="<?php echo base_url();?>configuraciones/procesadores/store" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="velocidad" id="velocidad" class="form-control" required="required">
                        </div>
                        <div class="form-group">
