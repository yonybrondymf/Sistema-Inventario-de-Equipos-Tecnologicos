<section class="content-header">
    <h1>
        Reportes <small> Monitores</small>
    </h1>
...
<section class="content">
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <a href="<?php echo base_url();?>reportes/monitores" class="btn btn-danger btn-flat">Reestablecer</a>
                        </div>
                    </div>
                </div>
                <hr>
                            ...
                            <tbody>
                                <?php foreach ($monitores as $monitor): ?>
                                    <tr>
                                        ...
                                        <?php $fecha = new DateTime($monitor->fecregistro); ?>
            ...
            <div class="row">
                <div class="col-md-4">
                    <form action="<?php echo base_url();?>reportes/monitores/exportar" method="POST">
                ...
                <div class="col-md-8">
                    <div class="paginacionMon text-right">
