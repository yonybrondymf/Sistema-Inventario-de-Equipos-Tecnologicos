...
<section class="content">
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="<?php echo base_url();?>configuraciones/fincas/add" class="btn btn-primary btn-flat"><span class="fa fa-plus"></span>Agregar Fabricante</a>
                    <hr>
